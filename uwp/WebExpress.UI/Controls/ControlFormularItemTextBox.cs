...
namespace WebExpress.UI.Controls
{
    public class ControlFormularItemTextBox : ControlFormularItemInput
    {
        ...
        public string InitializeCode
        {
            get
            {
                return new JQuerry(!string.IsNullOrWhiteSpace(ID) ? ID : "summernote").ToString() + ".summernote({ tabsize: 2, height: " + Height + ", lang: 'de-DE' });";
            }
        }
        ...
        public string DestroyCode
        {
            get
            {
                return new JQuerry(!string.IsNullOrWhiteSpace(ID) ? ID : "summernote").ToString() + ".summernote('destroy');"; 
            }
        }
