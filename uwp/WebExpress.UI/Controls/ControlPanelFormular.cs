...
namespace WebExpress.UI.Controls
{
    public class ControlPanelFormular : ControlPanel, IControlFormular
    {
        ...
        protected virtual void OnProcess()
        {
            ...
            {
                ProcessFormular(this, new EventArgs());
            }
        }
        ...
        {
            if (ProcessAndNextFormular != null)
            {
                ProcessAndNextFormular(this, new EventArgs());
            }
        }
        ...
        {
            if (InitFormular != null)
            {
                InitFormular(this, new EventArgs());
            }
        }
